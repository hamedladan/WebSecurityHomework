...
$sql="select user.name, user.firstName, user.userID from user,studentcourse,semester,course where semester.default='1' and semester.semesterID=course.semesterID and user.userID=studentcourse.idStudent and studentcourse.idCourse=course.courseID group by user.userID order by user.name, user.firstName";
...
<div class="container">
<div class='top'>
<div class="title"><h1>University Marks Manager: Admin Home-Page</h1></div>
<?php
